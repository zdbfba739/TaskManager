...
namespace BSF.Db
{
    ...
    public abstract class DbConn : IDisposable
    {
        ...
        protected DbConnection _conn=new MySqlConnection();
        ...
        public static string CreateConnString(DbType dbtype, string AServerName, string ADatabaseName, string ALoginName, string ALoginPass)
        {
            switch (dbtype)
            {
                ...
                case DbType.MYSQL:
                    //return "Database=" + AServerName + ";User Id=" + ALoginName + ";Unicode=True;password=" + ALoginPass;
                    return "server=" + AServerName + ";Initial Catalog=" + ADatabaseName + ";User ID=" + ALoginName + ";Password=" + ALoginPass;
            }
            return "";
